...
import ui.controllers.user.UserController;
 ...
 * <p>
 * Hosts the user tabs (Home, Project Management, FTP, Gmail, Logout) and exposes a minimal API
 * for controllers to read/change the current tab.
 */
public class UserView extends JPanel {
    ...
    public UserView(CardContainerView cardContainerView, RootController rootController) {
        Objects.requireNonNull(cardContainerView, "cardContainerView");
        ...
        userController = new UserController(rootController, tabbedPane);
    ...
    private void createTabbedPane() {
        ...
        // User-mode: restrict Project Management to current user's related projects.
        var currentUser = AuthenticationService.getCurrentUser();
        int userId = currentUser != null ? currentUser.getId() : 0;
        projectManagementPanel = new ProjectManagementPanelView(userId);
    ...
    /**
     * Returns to the default "Home" tab and resets the Project Management panel state (if present).
     */
